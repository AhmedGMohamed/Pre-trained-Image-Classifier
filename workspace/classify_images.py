...
from get_input_args import get_input_args as in_args
...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        image_classification = classifier(in_args().dir + key, model)
        
        model_label = image_classification.lower().strip()
        
        check = results_dic[key][0]
        
        if check in model_label:
